...
> v0.1.4. The SRD catalog, user accounts (with password and email
> management), and books are live; homebrew authoring and campaigns
> are next. See the [roadmap](docs/roadmap.md).
