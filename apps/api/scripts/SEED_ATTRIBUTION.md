...
All content seeded by `seed_srd.py` originates from the Dungeons & Dragons
5th Edition Systems Reference Document and is used under open licenses. This
file documents the required attributions for both the content and the data
compilation.
...
Copyright 2016, Wizards of the Coast LLC.
